...
namespace SistemaRiesgo.GestionarEmpleado
{
    public partial class ListaEmpleados : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                idDepartamento = Int32.Parse(Request.Params["id"]);
                TextBoxDepto.Text = Request.Params["id"];
                TextBoxDepto.ReadOnly = true;
            }
            ...
            if (depto == null)
            {
                NoDepto.Text ="No existen departamentos registrados aún" ;
